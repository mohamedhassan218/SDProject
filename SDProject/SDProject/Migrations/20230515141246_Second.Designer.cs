...
namespace SDProject.Migrations
{
    ...
    [Migration("20230515141246_Second")]
            ...
            modelBuilder.Entity("SDProject.Models.Report", b =>
                {
                    ...
                    b.HasIndex("MyCaseCaseId");

                    b.ToTable("Reports");
                });

            modelBuilder.Entity("SDProject.Models.SignUpAdmin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
